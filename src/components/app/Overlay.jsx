...
const Overlay = ({ children, title, onClose }) => {
  return (
    <div className="fixed inset-0 top-[8.8%] lg:left-[20%] w-full flex items-center justify-center bg-black bg-opacity-30">
      <div className="relative bg-white border lg:right-[10%] border-gray-200 rounded-md p-6 m-5 overflow-y-auto">
        {/* Header */}
